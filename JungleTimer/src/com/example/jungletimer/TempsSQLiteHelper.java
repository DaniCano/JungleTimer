 ...
 *
 */
public class TempsSQLiteHelper extends SQLiteOpenHelper {
	// Sentència SQL per crear la taula de Titulars
	private final String SQL_CREATE_TEMPS = "CREATE TABLE Temps(" +
	 ...
	 */
	public TempsSQLiteHelper(Context context, String nom, CursorFactory factory, int versio) {
	...
	public void onUpgrade(SQLiteDatabase db, int versioAnterior, int versioNova) {
		...
		db.execSQL("DROP TABLE IF EXISTS Temps");
