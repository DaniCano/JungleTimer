...
public class MainActivity extends ActionBarActivity implements
	...
	private void crearMenuLateral() {
		...
		opcionsMenuLateral.add("Home");
		opcionsMenuLateral.add("Twisted Treeline");
		opcionsMenuLateral.add("Summoner's Rift");
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		// modificar el títol
		getSupportActionBar().setTitle(opcionsMenuLateral.get(position));
